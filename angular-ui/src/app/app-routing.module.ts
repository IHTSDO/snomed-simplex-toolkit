...
import { LanguagePolicyPageComponent } from './components/language-policy-page/language-policy-page.component';
...
const routes: Routes = [
  ...
  { path: 'translation-studio/:edition/language-policy/:refsetId', component: LanguagePolicyPageComponent },
