package org.snomed.simplex.translation.util;
...
class ConceptExplanationMarkdownTest {
	...
	void testGetMarkdown() throws IOException {
		String markdown = ConceptExplanationMarkdown.getMarkdown(getConcept("/dummy-concepts/429926006.json"));
		assertEquals("""
				#### Concept Details
	...
	void testGetMarkdownConcreteDomain() throws IOException {
		String markdown = ConceptExplanationMarkdown.getMarkdown(getConcept("/dummy-concepts/348315009.json"));
		assertEquals("""
			   #### Concept Details
